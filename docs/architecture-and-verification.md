...
| P6-T3 event-log connection/command columns | Completed | `ae99e20`; stamp from last status; watermark preserved; Debug 190/190, manifest `dbc1e85e97bbc3d3b64a57ab020492116d1fabe1bfe3b150b643d62c97eeb3c8`; [P6-T3 receipt](verification/p6-t3-event-log-columns.md) |
| P7-T1 scenario matrix | Completed | tracked `docs/verification/scenario-matrix.md`; S01–S14; ACK timeout / WaitingForFreshInput test+log |
| P7-T2 clean Release verification | Completed | source HEAD `f600f2a`; SDK 10.0.400; Release 209/209; [receipt](verification/p7-t2-release-verification.md) |
| P7-T4 app captures | Completed | six `docs/demo/images/p7-*.png`; [receipt](verification/p7-t4-app-captures.md) |
| P7-T5 v1.0 receipt | tracked | [v1.0-release-receipt.md](verification/v1.0-release-receipt.md); live captures present; no tag |
